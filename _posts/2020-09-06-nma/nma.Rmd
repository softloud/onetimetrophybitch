...
$$
y_k \sim N(\mu + \gamma_k + \beta X, \sigma)\\
...
# Understanding the Parkinsons model
...
$$
y_{\cdot jk} \sim \text{normal}(\mu_j + \delta_{jk}, \sigma^2)\\
\mu_j \sim \text{normal}(0, 100^2)\\
\delta_{jk} \sim \text{normal}(0, \tau^2)\\
...
A warning is generated, prompting us to 
