...
> Special thinks to [Laura Ación](https://twitter.com/_lacion_), [Hao Ye](https://twitter.com/Hao_and_Y), and [James Goldie](https://twitter.com/rensa_co) for checking the maths, and for the reflections on how they understand `%>%` in their own work. 
...
sample(seq(20, 100), 1) %>% 
  # generate sample from normal distribution with mean 50 & sd 0.5
rnorm(., 50, 0.5) %>%
