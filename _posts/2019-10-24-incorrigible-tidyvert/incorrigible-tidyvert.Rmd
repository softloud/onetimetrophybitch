...
Brian A. Davey's MAT4GA _General Algebra_ coursebook provides this definition.

For $n \ in \mathbb N_0 := \mathbb N \cub \{ 0\}$, a map $f : A^n \to A$ is called an **_n_-ary operation on _A_**. 
