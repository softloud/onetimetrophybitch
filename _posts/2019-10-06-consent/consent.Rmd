...
I think it's extra common for me because of some kind of nineteenth century medicine, the *consumption*, interpretation of mental health.  I am not without my faculties; I don't need you to think for me. Mental health is not a dichotomy. I experience emotions in extremes, and that makes life a bit harder, that's it.
...
knitr::include_graphics("river-sense.gif")
```

This is an infinite loop of harmful help, driven by the principle of magical intent  [@mcewan_harmful_2011], whereby the person believes good intentions mitigates all harm, and misplaced superiority. This is nonsense; this is irrational. If I accidentally run over your cat, doesn't make it not dead, and doesn't reduce your grief. 

***

I don't require you to determine what is to my benefit; and will not appreciate it being up for debate. Indeed, I will likely find it offensive and harmful.

```{r  fig.align="center", out.width="20%", fig.cap="Being cast as the [noble savage](https://www.wikiwand.com/en/Noble_savage) and then the [mad woman in the attic](https://www.wikiwand.com/en/The_Madwoman_in_the_Attic) is getting old. [Image source.](https://psmag.com/.image/t_share/MTMzMTAxMjY3ODk0NDQyNDYy/pocahontasjpg.jpg)."}

knitr::include_graphics("pocahontas.jpg")
