...
Let $y_k$ denote the pairwise comparison between the unvaccinated and vaccinated groups, for the $k$th study. Then, we assume $y_k$ may be thought of in terms of the overall pairwise comparison, $\mu$, with an adjustment $\theta_k$. With sampling error, $
\varepsilon$, so that we have the following system.

\begin{array}{rcl}
y_k & = & 
\end{array}

> What is the commparison for a binomial. 
