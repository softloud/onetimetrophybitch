...
rankings %>%
  ...
  coord_flip() +
  labs(
    title = "network meta-analysis ranking distributions", 
    subtitle = str_wrap("on treatments for all subsets of the available 7 studies", 80),
    x = "number of combinations for k studies",
    caption = str_wrap("Bar plots are grouped by k, then number of studies.", 60)
  )
